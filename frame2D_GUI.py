...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.6 on Sun Nov  1 10:57:38 2020
#
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.combo_box_1 = wx.ComboBox(self, wx.ID_ANY, choices=["stiff2D", "stiff3D"], style=wx.CB_DROPDOWN | wx.CB_READONLY)
    ...
    def __do_layout(self):
        ...
        label_2 = wx.StaticText(self, wx.ID_ANY, "Which one?", style=wx.ALIGN_CENTER)
        label_2.SetForegroundColour(wx.Colour(192, 192, 192))
        sizer_3.Add(label_2, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
        sizer_3.Add(self.combo_box_1, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
        ...
        sizer_5.Add((20, 20), 2, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
